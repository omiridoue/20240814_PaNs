...
**Step 2** There are many ways to host your the presentation you have rendered through Quarto. We will piece this locally and deploy our page to GitHub through the \docs branch option.
**Step 3**Your slides will then be public and findable under https://yourGitHubusername.github.io/NameofRepository. Note if you have a GitHub education page you don't need to make the repo public, but your slides will be public.
